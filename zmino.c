...
Project    :  Tetris
File       :  zmino.c
Function   :  Zmino Function to Control
...
/*=======================================================================
Func Name     :  zmino
Function      :  Display and Control Zmino
Param Input   :  None
Param Output  :  None
Return Val    :  None
...
void zmino(void)
{
    ...
    -----------------------------------*/
        switch (cnt % 4) {
            case 0:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height + 2][x + 4] == 2 || g_stage[height + 2][x + 5] == 2 || g_stage[height + 1][x + 3] == 2) {
            ...
            case 2:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height + 2][x + 5] == 2 || g_stage[height + 2][x + 6] == 2 || g_stage[height + 1][x + 4] == 2) {
                    g_stage[height + 1][x + 5] = 2;
