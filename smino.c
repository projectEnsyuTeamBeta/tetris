...
Project    :  Tetris
File       :  smino.c
Function   :  Smino Function to Control
...
/*=======================================================================
Func Name     :  smino
Function      :  Display and Control Smino
Param Input   :  None
Param Output  :  None
Return Val    :  None
...
void smino(void)
{
    ...
    -----------------------------------*/	
        switch (cnt % 4) {
            case 0:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height + 1][x + 3] == 2 || g_stage[height + 1][x + 4] == 2 || g_stage[height][x + 5] == 2) {
            ...
            case 1:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height][x + 4] == 2 || g_stage[height + 1][x + 5] == 2) {
            ...
            case 2:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height + 1][x + 4] == 2 || g_stage[height + 1][x + 5] == 2 || g_stage[height][x + 6] == 2) {
            ...
            case 3:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height + 2][x + 4] == 2 || g_stage[height + 2][x + 5] == 2) {
                    g_stage[height - 1][x + 4] = 2;
                    g_stage[height][x + 4] = 2;
                    g_stage[height][x + 5] = 2;
                    g_stage[height + 1][x + 5] = 2;
