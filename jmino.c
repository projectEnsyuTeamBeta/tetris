...
Project    :  Tetris
File       :  jmino.c
Function   :  Jmino Function to Control
...
/*=======================================================================
Func Name     :  jmino
Function      :  Display and Control Jmino
Param Input   :  None
Param Output  :  None
Return Val    :  None
...
void jmino(void)
{
    ...
    -----------------------------------*/
        while (1) { 
            if (PORT0.PIDR.BIT.B0 == 1 && x > LEFT_WALL) {        /* SW4 : 左移動 */
                ...
                memcpy(J_mino, temp, sizeof temp);
                break;
            }
            /* ウェイト */
    ...
    -----------------------------------*/
        switch (cnt % 4) {
            ...
            case 1:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height + 1][x + 4] == 2 || g_stage[height - 1][x + 5] == 2) {
            ...
            case 2:
                /* 設置処理1　途中にミノがあった場合 */
                if (g_stage[height][x + 4] == 2 || g_stage[height][x + 5] == 2 || g_stage[height + 1][x + 6] == 2) {
